...
public class Solve1 {
    ...
    /*
     * Execute the reboot steps. Afterward, considering only cubes
     * in the region x=-50..50,y=-50..50,z=-50..50,
     * how many cubes are on?
     */
    public static long solve() {
        var clip = Cuboid.parse("on x=-50..50,y=-50..50,z=-50..50");

//        return HELLO_INPUT.lines()
